...
import AccountTransferPanel from './AccountTransferPanel.vue'
const props = defineProps<{ user?: User }>()
const emit = defineEmits<{ guide: []; changed: [] }>()
const idNotice = ref('')
